...
def try_hex_to_int(valor_hex: str) -> int:
    """
    Tenta converter um valor hexadecimal para inteiro ou devolve zero
    """
    try:
...
def __gerar_hash_cookie(texto: str) -> str:
    """
        Função para gerar o hash de uma string para usar no cookie
    """
    texto = settings.SALTY + str(texto) + '__ervamate'
...
def gerar_hash_senha(senha: str) -> str:
    """
    Função que gera e retorna o hash
    """
